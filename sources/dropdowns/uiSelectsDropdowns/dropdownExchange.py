        ...
        try:
            ...
            if int(view.value) == 0:
                ...
                embed = (
                    CustomEmbed(
                        "Foxbit Settings",
                        "1. Connect Gensen to your Foxbit account by adding the API keys which can be obtained from the [official website](https://app.foxbit.com.br/profile/api-key).\n"
                        "2. **Completely** remove the data from your exchange account in Gensen's database by clicking **disconnect**."
